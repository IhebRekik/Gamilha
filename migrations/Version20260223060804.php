 ...
 */
final class Version20260223060804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chat_ai ADD updated_at DATETIME DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
