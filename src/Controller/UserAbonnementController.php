...
final class UserAbonnementController extends AbstractController
{
    ...
    public function subscribe(Request $request, EntityManagerInterface $entityManager, UserRepository $userRepository, UserAbonnementRepository $userAbonnementRepository, int $id): Response
    {
